= Welcome to the Jakarta RESTful Web Services Demo Application
...
This project is a demonstration on how to use the https://jakarta.ee/specifications/restful-ws/[Jakarta RESTful Web Services] specification.
...
`$ java -jar <path>/payara-micro-<version>.jar target/rest-1.0.0.war`
...
http://localhost:8080/rest-1.0.0[Main Application]
