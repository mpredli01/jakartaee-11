= Welcome to the Jakarta Servlet Demo Application
...
This project is a demonstration on how to use the https://jakarta.ee/specifications/servlet/[Jakarta Servlet] specification.
...
`$ java -jar <path>/payara-micro-<version>.jar target/servlet-1.0.0.war`
...
http://localhost:8080/servlet-1.0.0[Main Application]
