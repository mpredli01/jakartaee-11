= Welcome to the Jakarta Data Demo Application
...
This project is a demonstration on how to use the https://jakarta.ee/specifications/data/[Jakarta Data] specification.
...
`$ java -jar <path>/payara-micro-<version>.jar target/data-1.0.0.war`
...
http://localhost:8080/data-1.0.0[Main Application]
