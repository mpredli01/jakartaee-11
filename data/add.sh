...
curl -X POST -H "Content-Type: application/json" -d '{"_id": 15, "name": "Marco Island Stout", "type": "STOUT", "brewer_id": 8, "abv": 9.0}' http://localhost:8080/data-1.0.0/data/beer/15
